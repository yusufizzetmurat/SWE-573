...
from api.models import ReputationRep, NegativeRep
...
class TestReputationViewSet:
    ...
    def test_create_reputation(self):
        ...
        response = client.post('/api/reputation/', {
            'handshake': str(handshake.id),
            'receiver': str(provider.id),
            'is_punctual': True,
            'is_helpful': True,
            'is_kind': True,
...
class TestNegativeRepViewSet:
    ...
    def test_create_negative_reputation(self):
        ...
        response = client.post('/api/negative-reputation/', {
            'handshake': str(handshake.id),
            'receiver': str(provider.id),
            'is_late': True,
    ...
    def test_negative_reputation_affects_karma(self):
        ...
        client.post('/api/negative-reputation/', {
            'handshake': str(handshake.id),
            'receiver': str(provider.id),
            'is_late': True
        })
